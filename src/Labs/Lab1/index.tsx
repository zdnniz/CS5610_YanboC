export default function Lab1() {
    return (
        <div id="wd-lab1">
            ...
            My favourite recipe: Fluffy French Toast
            <ol id="wd-pancakes">
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <input placeholder="ycheng" id="wd-text-fields-username" /> <br />
                    <label htmlFor="wd-text-fields-password">Password:</label>
                    <input type="password" value="password" id="wd-text-fields-password" />
                    <br />
                    <label htmlFor="wd-text-fields-first-name">First name:</label>
                    <input type="text" placeholder="Yanbo" id="wd-text-fields-first-name" /> <br />
                    <label htmlFor="wd-text-fields-last-name">Last name:</label>
                    <input type="text" placeholder="Cheng"
                        value="Cheng"
                        title="The last name"
            ...
            <h5 id="wd-buttons">File Upload Button</h5>
            <form>
